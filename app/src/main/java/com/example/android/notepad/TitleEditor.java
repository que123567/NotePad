...
public class TitleEditor extends Activity {
    ...
    private static final int COLUMN_NAME_CREATE_DATE = 3;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mCursor = managedQuery(mUri,        // The URI for the note that is to be retrieved.
        ...
        mTvTimeStamp = (TextView) this.findViewById(R.id.tv_time_stamp);
    }
    ...
    protected void onResume() {
        ...
        if (mCursor != null) {
            ...
            //mTvTimeStamp.setText(mCursor.getInt(COLUMN_NAME_CREATE_DATE)); BUG
        }
    }
    ...
    protected void onPause() {
        ...
        if (mCursor != null) {
            ...
            getContentResolver().update(mUri,    // The URI for the note to update.
                    values,  // The values map containing the columns to update and the values to
                    // use.
